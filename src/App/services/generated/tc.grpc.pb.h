...
class towncrier final {
 public:
  ...
  typedef WithAsyncMethod_attest<WithAsyncMethod_status<WithAsyncMethod_process<Service > > > AsyncService;
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_attest<ExperimentalWithCallbackMethod_status<ExperimentalWithCallbackMethod_process<Service > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_attest<ExperimentalWithCallbackMethod_status<ExperimentalWithCallbackMethod_process<Service > > > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_attest<WithStreamedUnaryMethod_status<WithStreamedUnaryMethod_process<Service > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_attest<WithStreamedUnaryMethod_status<WithStreamedUnaryMethod_process<Service > > > StreamedService;
};
